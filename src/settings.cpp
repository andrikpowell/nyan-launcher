...
Settings::Settings(QWidget *parent) : QWidget(parent), ui(new Ui::Settings)
{
    ...
    ui->PWADFolders_textBrowser->setText("When droping .lmp files into the launcher, it autoselects the correct IWAD, PWADs and complevel.\n\n"
                                         "For this to work, you need to add the folders you have your PWADs in, to the following container.");
    ui->IWADFolders_textBrowser->setText("The launcher will search for IWADs on these folders.");
    ...
    else
    {
        ...
        ui->IWADFolders_pushButton->setStyleSheet(STYLE_MAC_BUTTON_DARK);
         ...
         qApp->setStyleSheet("* {color: rgb(221, 221, 221);background: rgb(53, 53, 53);}"
                             ...
                             "QTabBar {qproperty-drawBase: 0;border: none;font-weight: bold;}"
                             ...
                             "QTabBar::tab::selected {font-weight: normal;background: rgb(53,53,53); margin-left: -3px;margin-right: -3px;border-top: 1px solid rgb(79, 79, 79);border-bottom:none;}"
                             "QTabBar::tab:!selected {font-weight: normal;margin-top: 4px;background: rgb(47, 47, 47);border-top: 1px solid rgb(79, 79, 79);border-bottom: 1px solid rgb(79, 79, 79);}"
