...
void states::loadStateV1(QTextStream &stream)
{
    ...
    while (!stream.atEnd())
    {
        ...
        else if (buffer_name == "warp1") MainWindow::pMainWindow->episode_lineEdit()->setText(buffer_value);
        ...
        else if (buffer_name == "hud") MainWindow::pMainWindow->hud_lineEdit()->setText(buffer_value);
        else if (buffer_name == "config") MainWindow::pMainWindow->config_lineEdit()->setText(buffer_value);
        else if (buffer_name == "track") // track
        {
            if (buffer_value.length() > 0) MainWindow::pMainWindow->track_comboBox()->setCurrentIndex(buffer_value.toInt());
            else MainWindow::pMainWindow->track_comboBox()->setCurrentIndex(0);
        }
        else if (buffer_name == "time") // time
        {
            if (buffer_value.length() > 0) MainWindow::pMainWindow->time_comboBox()->setCurrentIndex(buffer_value.toInt());
            else MainWindow::pMainWindow->time_comboBox()->setCurrentIndex(0);
        }
        else if (buffer_name == "pwad")
        {
        ...
        else if (buffer_name == "record") MainWindow::pMainWindow->record_lineEdit()->setText(buffer_value);
        else if (buffer_name == "playback") MainWindow::pMainWindow->playback_lineEdit()->setText(buffer_value);
        else if (buffer_name == "demodropdown")
        {
            if (buffer_value.length() > 0) MainWindow::pMainWindow->playback_comboBox()->setCurrentIndex(buffer_value.toInt());
            else MainWindow::pMainWindow->playback_comboBox()->setCurrentIndex(0);
        }
        else if (buffer_name == "viddump") MainWindow::pMainWindow->viddump_lineEdit()->setText(buffer_value);
        else if (buffer_name == "additional") MainWindow::pMainWindow->additionalArguments_textEdit()->setText(buffer_value);
    }
}
