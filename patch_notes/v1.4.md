...
- Fixed Episode IWADs (Doom 1, Heretic, etc) Episode / Map Selection
- Added IWAD Support for Chex Quest 3 (Vanilla + Modding)
...
- Added support for the new data folders of Nyan Doom
  - macOS: ~/Library/Application Support
  - Linux: XDG_DATA_HOME and ~/.local/share
- Added auto updater for Nyan Doom
...
- Removed DSDA tab
- New Icon to differenciate but not deviate from Nyan Doom
